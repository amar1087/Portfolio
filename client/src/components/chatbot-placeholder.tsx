  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Chat Interface */}
        {isChatOpen && (
          <div className={`fixed bottom-4 right-4 bg-white rounded-lg shadow-2xl border border-slate-200 z-50 ${isMinimized ? 'h-16' : 'h-[400px]'} ${isMinimized ? 'w-80' : 'w-[500px]'} flex flex-col`}>
            {/* Chat Header */}
