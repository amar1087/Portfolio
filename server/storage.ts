...
export class MemStorage implements IStorage {
  ...
  private initializeContactInfo() {
    this.contactInfo = {
      id: randomUUID(),
      name: "Amarjeet Kaur",
      title: "AI Solutions Consultant & Full Stack Developer",
      email: "amar1087@gmail.com",
      location: "Delhi, India",
      linkedin: "https://www.linkedin.com/in/amarjeet-kaur-1087",
      website: "https://amarjeetkaur.com",
      bio: "Results-driven Developer and Cloud Architect with 15+ years of expertise in designing intelligent, autonomous AI agents. I leverage cutting-edge frameworks like OpenAI SDK, CrewAI, LangGraph, and AutoGen to create sophisticated multi-agent systems that automate complex workflows and drive efficiency."
    };
  }
  ...
  private initializePortfolioData() {
    const data: Omit<PortfolioData, 'id'>[] = [
      ...
      { type: 'skill', title: 'AWS', category: 'primary', priority: 4, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'TypeScript', category: 'primary', priority: 5, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'Python', category: 'primary', priority: 6, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'MongoDB', category: 'primary', priority: 7, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'PostgreSQL', category: 'primary', priority: 8, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'TensorFlow', category: 'primary', priority: 9, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'HTML & CSS', category: 'primary', priority: 10, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'JavaScript', category: 'primary', priority: 11, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'AI Engineering', category: 'primary', priority: 12, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },

      // AI & ML Skills
      { type: 'skill', title: 'OpenAI SDK', category: 'ai', priority: 1, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'CrewAI', category: 'ai', priority: 2, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'LangGraph', category: 'ai', priority: 3, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'AutoGen', category: 'ai', priority: 4, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      ...
      { type: 'skill', title: 'n8n', category: 'ai', priority: 6, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },

      // Cloud & DevOps Skills
      { type: 'skill', title: 'AWS Lambda', category: 'cloud', priority: 1, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'EC2', category: 'cloud', priority: 2, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'S3', category: 'cloud', priority: 3, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'API Gateway', category: 'cloud', priority: 4, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'DynamoDB', category: 'cloud', priority: 5, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'Jenkins', category: 'cloud', priority: 6, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'CI/CD', category: 'cloud', priority: 7, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },

      // Development Tools
      { type: 'skill', title: 'Cursor', category: 'tools', priority: 1, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'GitHub Copilot', category: 'tools', priority: 2, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'Jest', category: 'tools', priority: 3, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'Cypress', category: 'tools', priority: 4, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'NgRx', category: 'tools', priority: 5, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
      { type: 'skill', title: 'RxJS', category: 'tools', priority: 6, description: null, company: null, location: null, startDate: null, endDate: null, technologies: null, achievements: null },
